  ...
  request({
    ...
    if (error) {
        ...
        if (response.statusCode == 200) {
          try {
            cb(body.apiKey, body.id, null);
          } catch (e) {
            cb(null, null, e);
          }
        } else {
          cb(null, null, body.error);
        }
    }
  });
};
...
module.exports.markEmailVerified = function(email, cb) {
...
module.exports.createUser = function(email, cb) {
  var compiled = "";
  try {
