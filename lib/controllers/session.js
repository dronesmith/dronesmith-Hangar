...
exports.forgotPassword = function (req, res, next) {
  log.warn("save session and token");
  req.session.token = "bender";
  req.session.save(function(err) {
...
// exports.tempSession = function (req, res, next) {
//   log.warn("Session start: " + req.sessionID);
//   req.session.token = "55555555555";
//   req.session.save(function(err) {
//     res.json({status: 'OK'});
//   });
//
...
exports.resetPassword = function (req, res, next) {
  ...
  if (req.body.token == req.session.token) {
    log.warn("Hooray you may now reset your password")
  }
  dss.getUser(req.body.email, function(user, err) {
